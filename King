...
\033[1;96m               | |                      
\033[1;96m               |_|   It's Kings world 0.3        
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
jalan("   \033[1;93m Welcome to Mr King Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mMrKing\033[1;96m•◈•──────────•◈•")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/kingonhydra')
    else:
...
def pilih_super():
	...
	jalan('                    \033[1;97mMr King start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
